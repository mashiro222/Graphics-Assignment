...
Ptr<Scene> GenScene12() {
	...
	sobj_areaLight->AddComponent<CmptLight>(AreaLight::New(lightColor, 1000.f));
	sobj_areaLight->AddComponent<CmptTransform>(pointf3(1.f, 3.f, 0.f), scalef3{ 1.f }, quatf(vecf3{ 1,0,0 }, to_radian(180.f)));
	sobj_areaLight->AddComponent<CmptGeometry>(Plane::New());
	sobj_areaLight->AddComponent<CmptMaterial>(BSDF_Emission::New(lightColor, 100.f));

	auto sobj_areaLight2 = SObj::New(sobjRoot, "area light");
	sobj_areaLight2->AddComponent<CmptLight>(AreaLight::New(lightColor, 1000.f));
	sobj_areaLight2->AddComponent<CmptTransform>(pointf3(-1.f, 3.f, 0.f), scalef3{ 1.f }, quatf(vecf3{ 1,0,0 }, to_radian(180.f)));
	sobj_areaLight2->AddComponent<CmptGeometry>(Plane::New());
	sobj_areaLight2->AddComponent<CmptMaterial>(BSDF_Emission::New(lightColor, 100.f));
