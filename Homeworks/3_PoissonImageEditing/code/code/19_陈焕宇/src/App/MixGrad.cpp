...
MixGrad::MixGrad(int width, int height,	vector<Vector2i>& vertices, 
...
double	MixGrad::NonlinearTerm(int p_row, int p_column, int q_row, int q_column)
{
	double x = source_value_(p_row, p_column) - source_value_(q_row, q_column);
	double y = target_value_(p_row, p_column) - target_value_(q_row, q_column);
