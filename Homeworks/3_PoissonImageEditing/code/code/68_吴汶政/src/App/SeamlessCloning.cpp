...
SeamlessCloning::SeamlessCloning()
{
...
SeamlessCloning::SeamlessCloning(Domain* source_domain)
{
	getSparseMartrixA(source_domain);
}

void SeamlessCloning::Clone(Domain* source_domain, cv::Point destination,
