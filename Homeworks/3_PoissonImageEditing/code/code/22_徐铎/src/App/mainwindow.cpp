...
void MainWindow::CreateActions()
{
	...
	// 	action_new_->setStatusTip(tr("Create a new file"));
		...
		// File IO
	action_open_ = new QAction(QIcon("../src/App/Resources/images/open.jpg"), tr("&Open..."), this);
	action_open_->setShortcuts(QKeySequence::Open);
	action_open_->setStatusTip(tr("Open an existing file"));
	connect(action_open_, SIGNAL(triggered()), this, SLOT(Open()));

	action_save_ = new QAction(QIcon("../src/App/Resources/images/save.jpg"), tr("&Save"), this);
	...
	// Poisson image choosing
	action_choose_rect_ = new QAction(tr("RectChoose"), this);
	action_choose_rect_->setStatusTip(tr("Choose rectangle region"));
	...
	action_copy_->setStatusTip(tr("Copy"));
...
void MainWindow::CreateMenus()
{
	...
	// Poisson Image Choosing
	menu_choose_ = menuBar()->addMenu(tr("&Choose"));
	menu_choose_->addAction(action_choose_rect_);
	menu_choose_->addAction(action_choose_polygon_);
	menu_choose_->addAction(action_choose_freehand_);
}
...
void MainWindow::ChooseFreehand()
{
	...
	if (!window)
		return;
	window->imagewidget_->set_draw_status_to_choose_Freehand();
	child_source_ = window;
}
