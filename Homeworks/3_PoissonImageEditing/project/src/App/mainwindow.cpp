...
void MainWindow::CreateActions()
{
	...
	action_paste_mixed_ = new QAction(tr("Paste_mixed"), this);
	connect(action_paste_mixed_, SIGNAL(triggered()), this, SLOT(Paste_mixed()));
...
void MainWindow::ChooseRect()
{
	...
	if (!window)
		return;
	window->imagewidget_->set_draw_status_to_chooseRect();
...
void MainWindow::ChooseFreehand()
{
	...
	if (!window)
		return;
	window->imagewidget_->set_draw_status_to_chooseFreehand();
	child_source_ = window;
}
